...
class GlobalConfig(BaseModel):
    ...
    llm_api_url: ClassVar[str] = "http://127.0.0.1:8080/v1/chat/completions"  # URL for the LLM API
    #llm_api_url: ClassVar[str] = "http://10.0.1.142:8080/v1/chat/completions"  # URL for the LLM API
